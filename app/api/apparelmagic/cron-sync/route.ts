    ...
    for (const wsId of workspaces) {
      ...
      try {
        ...
        const transformedInventory = targetInventory.map((item) => ({
          ...
          color: item.attr_2 || 'Unknown',
          size: item.size || 'Unknown',
          qty_on_hand: parseFloat(String(item.qty_inventory || 0)) || 0,
          qty_available: parseFloat(String(item.qty_avail_sell || 0)) || 0,
          qty_allocated: parseFloat(String(item.qty_alloc || 0)) || 0,
          qty_reserved: parseFloat(String(item.qty_picked || 0)) || 0,
          qty_open_po: parseFloat(String(item.qty_open_po || 0)) || 0,
